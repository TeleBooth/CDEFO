...
void loop() {
    ...
    if (nfc.tagPresent()) {
        ...
        message.addTextRecord("CDEFO is on its way"); // Text Message you want to Record
        message.addUriRecord("https://github.com/TeleBooth/CDEFO"); // Website you want to Record
